...
import com.example.administrator.lmw.mine.invite.adapter.FriendsTwoAdapter;
 ...
 */
public class FriendsTwoFragment extends BaseFragment implements XListView.IXListViewListener {
    ...
    private FriendsTwoAdapter adapter;
    private int level = 2;// 1:一级好友;2:二级好友
            ...
            public void onSuccess(BaseResult<FriendListEntity> friendListEntity) {
                ...
                if (friendListEntity.getCode().equals("0")) {
                    if (pageIndex == 1) {
                        ...
                        adapter = new FriendsTwoAdapter(mContext, friendListEntity.getData().getDatas(), R.layout.friends_item);
                    ...
                    title.setText("二级好友名称：共" + friendListEntity.getData().getTotalCount() + "人");
                    ...
                    adapter = new FriendsTwoAdapter(mContext, friendListDatas, R.layout.friends_item);
                    cumulativeXlv.setAdapter(adapter);
                }
            }
