...
public class PasswardEditText extends LinearLayout {
    ...
    public PasswardEditText(Context context) {
        this(context, null);
    }

    public PasswardEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        View v = LayoutInflater.from(context).inflate(R.layout.app_exchange_psw_edittext_layout, this, true);
        setView(v);
        setListener(context);
    }
