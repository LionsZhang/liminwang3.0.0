...
import com.example.administrator.lmw.view.XFooterView;
import com.example.administrator.lmw.view.XHeaderView;
...
public class CustListView extends ListView implements AbsListView.OnScrollListener {
    ...
    private CustListViewListener mListener;
     ...
     * @param listener
     */
    public void setCustListViewListener(CustListViewListener listener) {
        mListener = listener;
    }
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (deltaY > 10) {
                    if (onXScrollOreitationListener != null)
                        onXScrollOreitationListener.onXScrollingDown();
                }
                ...
                if (deltaY < -10) {
                    if (onXScrollOreitationListener != null)
                        onXScrollOreitationListener.onXScrollingUp();
                }
